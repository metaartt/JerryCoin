...
contract JerryCoin is Context, IERC20, Ownable {
    ...
    string private _name = "JerryCoin";
    string private _symbol = "JRC";
    uint8 private _decimals = 9;
    
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingWallet = payable(0x31E6793d9879AB06Bd094936c8AA90740CFE3ED3);
    ...
    uint256 public minimumTokensBeforeSwap = 100000000000 * 10**9;
    ...
    function setAllFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee) private {
        require(taxFee.add(_liquidityFee).add(marketingFee).add(burnFee) <= 15, "tax too high");
        _taxFee = taxFee;
